...
import PaginaLegal from "@/components/artesania/PaginaLegal";
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <a href="/artesania/privacidad">política de privacidad</a>; sobre el titular de la web, el{" "}
        <a href="/artesania/aviso-legal">aviso legal</a>.
      </p>
    </PaginaLegal>
  );
}
