...
import { entregar, puedeEnviar } from "@/lib/artesania/entrega";
import { errores, limpiar, type Solicitud } from "@/lib/artesania/solicitud";
 ...
 *
 * Dónde acaba cada solicitud lo decide `lib/artesania/entrega.ts`. Si no hay
