import { EMPRESA, loQueFalta } from "@/lib/config";
import { hayDondeEntregar } from "@/lib/entrega";
        ...
        {falta.length > 0 && (
          <div>
            <p className="font-semibold">
              Datos sin rellenar en <code>src/lib/config.ts</code>:
            </p>
        ...
        {!buzon && (
          <div>
            ...
            <p className="mt-1 text-amber-200/80">
              Pon <code>WEBHOOK_SOLICITUDES</code>, o <code>RESEND_API_KEY</code> con{" "}
              <code>EMAIL_DESTINO</code>, o conecta la base de datos. Mientras tanto el
