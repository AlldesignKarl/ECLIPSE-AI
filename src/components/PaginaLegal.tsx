...
export default function PaginaLegal({
  ...
  return (
    <>
      <header className="fondo-portada arte-grano relative overflow-hidden px-5 pb-16 pt-32 sm:px-8 sm:pb-20 sm:pt-40">
      ...
      <div className="fondo-catalogo px-5 py-16 sm:px-8 sm:py-24">
